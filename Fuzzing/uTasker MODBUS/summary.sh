...
qemu_params="./uEmu.uTasker_MODBUS.elf -sram_size 192k -flash_size 92k -flash_base 0x8000000 -machine embedded_fuzz -allow_flash_write -sram2_size 4k -sram2_base 0 -passthrough 4002900c,4002904c"
